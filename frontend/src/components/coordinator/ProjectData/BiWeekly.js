...
export default class BiWeekly extends Component {
  constructor(props) {
    ...
    this.onChangebiweeklyDiscription = this.onChangebiweeklyDiscription.bind(
      this
    );
  ...
  getBiweekly() {
    axios
      .get(backendURI.url + "/biweekly/getBiweeklyLink/" + this.state.projectId)
      .then((res) => {
        this.setState({
  ...
  getBiweeklyNumber() {
    axios
      .get(
        backendURI.url + "/biweekly/getBiweeklyNumber/" + this.state.projectId
      )
      .then((res) => {
        this.setState({
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            axios
              .patch(backendURI.url + "/biweekly/deleteBiweekly/" + id, {
                headers: headers,
              })
              .then((res) => {
                this.setState({
  ...
  viewBiweekly(data) {
    try {
      this.props.history.push(
        "/coordinatorhome/projectdata/viewbiweekly/" + this.state.projectId,
        { biweeklyData: data }
      );
    } catch (error) {
      console.log(error);
        ...
        <div className="proposel-style">
          <div className="container-fluid pro-back">
            <div className="container">
              <Tabs
                defaultActiveKey="Submited Biweekly"
                id="uncontrolled-tab-example"
                className="pro-tabs"
                style={{ marginBottom: "30px" }}
              >
                <Tab
                  eventKey="Submited Biweekly"
                  title="Submited Biweekly"
                  className="pro-tab"
                >
                  <div> </div>

                  {this.state.biweeklylList.length > 0 &&
                      ...
                      <div>
                        <div>
                          {this.state.biweeklylList.map((type) => {
                            return (
                              <div
                                className="card container  pcrd-style"
                                style={{ margin: "0px 0px 20px 0px" }}
                                key={type._id}
                              >
                                <Row className="pcrd_proposel-tittle-div">
                                  <Col md={12} xs={12}>
                                    <p className="pcrd_proposel-name">
                                      Biweekly report #{type.biweeklyNumber}
                                    </p>
                                  </Col>
                                </Row>
                                ...
                                <Row className="pcrd_user-name-div">
                                  <Col md={11} xs={10}>
                                    <p className="pcrd_date">
                                      &nbsp;{type.date}&nbsp;&nbsp;{type.time}
                                    </p>
                                  </Col>
                                </Row>
                                <div>
                                  <p className="pcrd_discription">
                                    {type.biweeklyDiscription}
                                  </p>
                                  <p className="dead_date">
                                    Dead Line:{type.deadDate} : {type.deadTime}
                                  </p>
                                </div>
                                <Row>
                                  <Col md={3} xs={12}>
                        ...
                        <form onSubmit={this.onSubmit}>
                          ...
                          <div className="form-group pro-form">
                            ...
                            <input
                              ...
                              id="exampleInputBiweekly"
                              errortext={this.state.biweeklyNumberError}
                              name="biweeklyNumber"
                              value={this.state.biweeklyNumber}
                              onChange={this.onChangebiweeklyNumber}
                            />
                            <p className="reg-error">
                              {this.state.biweeklyNumberError}
                            </p>
                          </div>
                          ...
                          <div className="form-group pro-form">
                            ...
                            <textarea
                              ...
                              name="biweeklyDiscription"
                              errortext={this.state.biweeklyDescriptionError}
                              value={this.state.biweeklyDiscription}
                              onChange={this.onChangebiweeklyDiscription}
                            />
                            <p className="reg-error">
                              {this.state.biweeklyDiscriptionError}
                            </p>
                          </div>
                            ...
                            <Col md={6} xs="12">
                              <div className="form-group pro-form">
                                ...
                                <input
                                  ...
                                  errortext={this.state.deadDateError}
                                />
                                <p className="reg-error">
                                  {this.state.deadDateError}
                                </p>
                              </div>
                            </Col>
                            ...
                            <Col md={6} xs="12">
                              <div className="form-group pro-form">
                                ...
                                <input
                                  ...
                                  id="exampleInputTime"
                                  name="deadTime"
                                  value={this.state.deadTime}
                                  onChange={this.onChangeTime}
                                  errortext={this.state.deadTimeError}
                                />
                                <p className="reg-error">
                                  {this.state.deadTimeError}
                                </p>
                              </div>
                            </Col>
                          </Row>
                          ...
                          <Row>
                            <Col md={6} xs="12">
                              <label className="verticle-align-middle  pro-form">
                                File Attach :{" "}
                              </label>
                            ...
                            <Col
                              className="col-padding-5 check-box"
                              md={6}
                              xs={12}
                            >
                              <FormControlLabel
                          ...
                          <Row>
                            <Col md={4} xs={12}>
                              ...
                              <input
                                type="number"
                                className="form-control"
                                id="examplesubmssionFileSize"
                                placeholder="1 MB"
                                value={this.state.submssionFileSize}
                                onChange={this.onChangesubmssionFileSize}
                              />
                            ...
                            <Col md={4}>
                              ...
                              <input
                                type="number"
                                className="form-control"
                                id="examplesetFileLimit"
                                placeholder="1"
                                value={this.state.setFileLimit}
                                onChange={this.onChangesetFileLimit}
                              />
                            </Col>
                          </Row>
                          <Row
                              ...
                              return (
                                ...
                                >
                                  <Row className="pcrd_proposel-tittle-div">
                                    ...
                                    <Col className="pcrd_btn-row" md={2} xs={2}>
                                      <EditIcon
                                        ...
                                        className="edit-btn"
                                        fontSize="large"
                                        onClick={() => this.onEditHandler(type)}
                                      />
                                      <DeleteForeverIcon
                                        style={{ marginTop: "5px" }}
                                  ...
                                  <div>
                                    ...
                                    <p className="dead_date">
                                      Dead Line Date :{type.deadDate}
                                    </p>
                                    <p className="dead_time">
                                      Dead Line Time :{type.deadTime}
                                    </p>
                                  </div>
