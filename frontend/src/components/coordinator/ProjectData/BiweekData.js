        ...
        {!this.state.loading1 && !this.state.loading2 && (
          <tr>
            ...
            <td>
              {!this.state.loading3 &&
                this.state.existing &&
                this.state.individualMarks.studentList.length > 0 &&
                this.state.individualMarks.studentList.map((item, key) => {
                  return (
                    <div key={key} style={{ fontSize: "11px" }}>
                      <span>{item} - </span>
                      <span>
                        {this.state.individualMarks.individualMarks[key]} Marks
                      </span>
                    </div>
                  );
                })}
              {!this.state.loading3 && !this.state.existing && (
                <p>Marks are not submitted yet</p>
              )}
