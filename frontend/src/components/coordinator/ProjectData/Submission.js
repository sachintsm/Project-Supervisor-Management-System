...
class Submission extends Component {
  constructor(props) {
    ...
    this.onChangeproposelDiscription = this.onChangeproposelDiscription.bind(
      this
    );
  ...
  getProposel() {
    axios
      .get(
        backendURI.url + "/proposel/getSubmisionLink/" + this.state.projectId
      )
      .then((res) => {
        this.setState({
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            axios
              .delete(backendURI.url + "/proposel/deleteSubmision/" + id, {
                headers: headers,
              })
              .then((res) => {
                this.setState({
        ...
        buttons: [
          {
            ...
            onClick: async () => {
              ...
              if (this.state.componentType === "add") {
                axios
                  .post(backendURI.url + "/proposel/addProposel", formData, {
                    headers: headers,
                  })
                  .then((res) => {
                    this.setState({
  ...
  viewSubmission(data) {
    try {
      this.props.history.push(
        "/coordinatorhome/projectdata/viewsubmission/" + this.state.projectId,
        { submissionData: data }
      );
    } catch (error) {
      console.log(error);
        ...
        <div className="proposel-style">
          <div className="container-fluid pro-back">
            <div className="container">
              <Tabs
                defaultActiveKey="Submited Submissions"
                id="uncontrolled-tab-example"
                className="pro-tabs"
                style={{ marginBottom: "30px" }}
              >
                <Tab
                  eventKey="Submited Submissions"
                  title="Submited Submissions"
                  className="pro-tab"
                >
                  <div> </div>
                        ...
                        <form onSubmit={this.onSubmit}>
                          ...
                          <div className="form-group pro-form">
                            ...
                            <input
                              ...
                              id="exampleInputProposel"
                              placeholder="Ex:- Project Proposal / Concept Paper / SRS"
                              errortext={this.proposelTittleError}
                              name="proposelTittle"
                              value={this.state.proposelTittle}
                              onChange={this.onChangeProposelTittle}
                            />
                            <p className="reg-error">
                              {this.state.proposelTittleError}
                            </p>
                          </div>
                          ...
                          <div className="form-group pro-form">
                            ...
                            <textarea
                              ...
                              name="proposelDescription"
                              errortext={this.state.proposelDescriptionError}
                              value={this.state.proposelDiscription}
                              onChange={this.onChangeproposelDiscription}
                            />
                            <p className="reg-error">
                              {this.state.proposelDescriptionError}
                            </p>
                          </div>
