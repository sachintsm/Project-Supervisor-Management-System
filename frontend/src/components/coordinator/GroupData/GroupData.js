...
class GroupData extends Component {
      ...
      await axios
        .get(
          backendURI.url +
            ...
            this.state.projectSupervisorList[i],
          { headers: headers }
        )
        .then((res) => {
          const option = {
  ...
  openBiweekly() {
    this.props.history.push(
      "/coordinatorhome/gdata/biweekly/" + this.state.groupId
    );
  }
  openProposal() {
    this.props.history.push(
      "/coordinatorhome/gdata/proposal/" + this.state.groupId
    );
  }
  openPresentation() {
    this.props.history.push(
      "/coordinatorhome/gdata/presentation/" + this.state.groupId,
                        ...
                        <Col md="8" xs="12">
                          <div className="form-group">
                            ...
                            <p className="reg-error">
                              {this.state.addStudentIndexError}
                            </p>
                          </div>
                        </Col>
                        <Col md="4" xs="12">
