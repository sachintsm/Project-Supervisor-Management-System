            ...
            <div style={{ backgroundColor: "#f8f8f8" }}>
                ...
                <div className="container group-submission" >
                    <Card className="submission-card">
                        <Card.Header className="gd-card-header">G1 - Traffic Optimiser BiWeekly Submissions</Card.Header>
                        <Card.Body className="gd-card-body">
                            ...
                            <Row>
                                ...
                                <Col md={9}>
                                    <Link className="prop-sub-attachment">Group_project_2_group_01.pdf</Link>
                                </Col>
                            </Row>
