...
export default class CreateGroups extends Component {
  ...
  fileUpload = (e) => {
    ...
    if (this.state.csvData.length === 0) {
      ...
      // ! check user select project or not
      this.setState({
        snackbaropen: true,
  ...
  handleChange = (e, index) => {
    ...
    let grpMembersTemp = this.state.grpMembers;
    grpMembersTemp[index] = e.target.value;
    this.setState({
      grpMembers: grpMembersTemp,
                  ...
                  >
                    ...
                    <Tab eventKey="single" title="Single Registration">
                      ...
                      >
                        ...
                        <div className="form-group">
                          <button
                            className="btn btn-secondary my-4 add-member"
