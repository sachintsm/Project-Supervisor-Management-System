...
class Index extends Component {
  ...
  toggle = () => {
    ...
    axios
      .get(backendURI.url + "/indexInfo/" + this.props.id) //Get the detais of the supervisors
      .then((res) => {
        this.setState({
  ...
  render() {
    return (
      <div>
        <a onClick={this.toggle} href="#0">
          <span style={{ cursor: "pointer", color: "rgb(16, 141, 212)" }}>
            {this.props.name}
          </span>
        </a>
          ...
          <ModalBody>
            <div className="container supervisor-data">
              <img
                alt=""
                src={
                  "http://localhost:4000/users/profileImage/" + this.state.image
                }
                className="sup-image"
              ></img>
              <br />
              ...
              <div style={{ marginTop: "20px" }}>
                ...
                <p className="details" style={{ marginTop: "20px" }}>
