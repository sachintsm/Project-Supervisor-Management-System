        ...
        buttons: [
          {
            ...
            onClick: () => {
              ...
              axios
                .post(backendURI.url + "/users/reset/" + userData.id, obj)
                .then((res) => {
                ...
                <Row>
                  <Col md={6} xs="12">
                    <div className="input-container" style={{ marginTop: 7 }}>
                      ...
                      <i
                        className={`fa ${
                          isNewShown ? "fa-eye-slash" : "fa-eye"
                        }  password-icon`}
                ...
                <Row>
                  <Col md={6} xs="12">
                    <div className="input-container" style={{ marginTop: 7 }}>
                      ...
                      <i
                        className={`fa ${
                          isConShown ? "fa-eye-slash" : "fa-eye"
                        }  password-icon`}
