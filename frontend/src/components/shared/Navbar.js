...
class navbar extends Component {
  ...
  readRequest() {
    ...
    var ob = [];
    axios
      .get(backendURI.url + "/users/countNotifyReq/" + userData.id)
      .then((response) => {
        ...
        for (var i = 0; i < ob.length; i++) {
          var Id = ob[i]._id;
          axios
            .post(backendURI.url + "/users/readRequest/" + Id, Id)
            .then((response) => {})
            .catch((error) => {});
        }
      })
  ...
  getStudentNotificationCount = () => {
    ...
    axios
      .get(backendURI.url + "/createGroups/groupformnotification/" + userId, {
        headers: headers,
      })
      .then((res) => {
        res.data.map((item) => {
          ...
          axios
            .post(
              backendURI.url + "/createGroups/allgrouprequest/" + userId,
              { project },
              { headers: headers }
            )
            .then((res2) => {
    ...
    axios
      .get(backendURI.url + "/createGroups/groupacceptingrequest/" + userId, {
        headers: headers,
      })
      .then((res) => {
        this.setState({
          groupNotificationCount:
            this.state.groupNotificationCount + res.data.length,
        });
      });
  };
  ...
  getSupervisorNotificationCount = async () => {
    ...
    this.setState({
      supervisorNotificationCount:
        this.state.biweeklyCount + this.state.supervisorRequestMeetings,
    });
  };
          ...
          >
            <MDBNavbarBrand>
              {this.state.panel === "admin" && (
                <Nav.Link className="navlink-icon" href="/adminhome">
                  <img
                    alt=""
                    href="/adminhome"
                    style={{ width: "12rem" }}
              ...
              {this.state.panel === "student" && (
                <Nav.Link className="navlink-icon" href="/studenthome">
                  <img
                    alt=""
                    href="/studenthome"
                    style={{ width: "12rem" }}
              ...
              {this.state.panel === "supervisor" && (
                <Nav.Link className="navlink-icon" href="/supervisorhome">
                  <img
                    alt=""
                    href="/supervisorhome"
                    style={{ width: "12rem" }}
              ...
              {this.state.panel === "coordinator" && (
                <Nav.Link className="navlink-icon" href="/coordinatorhome">
                  <img
                    alt=""
            ...
            <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
              <MDBNavbarNav className="navbar-nav" right>
                ...
                <MDBNavItem className="mr-4">
                  {this.state.panel === "coordinator" && (
                    <Nav.Link href="/coordinatorhome/presentationfeedback">
                ...
                {this.state.panel === "coordinator" && (
                  <MDBDropdown>
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem href="/shared/noticeView">
                        View Notices
                      </MDBDropdownItem>
                      <MDBDropdownItem href="/shared/notice">
                        Create Notice
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                ...
                {this.state.panel === "coordinator" && (
                  <MDBDropdown className="mr-4">
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem href="/coordinatorhome/createGroups">
                        Create Groups
                      </MDBDropdownItem>
                      <MDBDropdownItem href="/coordinatorhome/projectGroups">
                        View Groups
                      </MDBDropdownItem>
                      <MDBDropdownItem href="/coordinatorhome/assignSupervisors">
                        Assign Supervisors
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                ...
                {this.state.panel === "admin" && (
                  <MDBDropdown className="mr-4">
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem href="/adminhome/viewusers">
                        Manage Users
                      </MDBDropdownItem>
                      <MDBDropdownItem href="/adminhome/registration">
                        User Registrations
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                ...
                {this.state.panel === "admin" && (
                  <MDBDropdown className="mr-4">
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem href="/adminhome/projecttypes">
                        Course Types
                      </MDBDropdownItem>
                      <MDBDropdownItem href="/adminhome/createproject">
                        Create Course
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                  ...
                  <MDBNavItem className="mr-4">
                    <BootstrapTooltip1 title="Mailbox" placement="bottom">
                      <Nav.Link
                        ...
                        href="/adminhome/viewmailbox"
                      >
                        <span className="icon">
                          <Icon style={{ fontSize: 30 }}>drafts</Icon>
                        </span>
                      </Nav.Link>
                    </BootstrapTooltip1>
                  </MDBNavItem>
                ...
                {this.state.panel === "supervisor" && (
                  <MDBNavItem className="mr-4">
                    <Nav.Link
                      className="padding-zero"
                      href="/supervisorhome/givepresentationfeedback"
                    >
                      Presentation Feedback
                    </Nav.Link>
                  </MDBNavItem>
                ...
                {this.state.panel === "supervisor" && (
                  <MDBNavItem className="mr-4">
                    <Nav.Link
                      className="padding-zero"
                      href="/supervisorhome/viewRequest"
                      onClick={this.readRequest}
                    >
                      Group Requests
                      <span className="icon">
                        {this.state.count > 0 && (
                ...
                {this.state.panel === "student" && (
                  <MDBNavItem className="mr-4">
                    <Nav.Link
                      className="nav-link padding-zero"
                      href="/shared/noticeView"
                    >
                      Notices{" "}
                    </Nav.Link>
                ...
                <MDBNavItem className="mr-3">
                  {this.state.panel === "student" && (
                    <BootstrapTooltip1 title="Notifications" placement="bottom">
                      <Nav.Link
                        className="padding-zeroo"
                        href="/studenthome/notifications"
                      >
                        <span className="icon">
                          <Icon style={{ fontSize: 30 }}>notifications </Icon>
                          {this.state.groupNotificationCount > 0 && (
                            <Badge
                              style={{ verticalAlign: "top" }}
                              variant="danger"
                            >
                              {this.state.groupNotificationCount}
                            </Badge>
                          )}
                        </span>
                      </Nav.Link>
                  ...
                  {this.state.panel === "coordinator" && (
                    <BootstrapTooltip1 title="Notifications" placement="bottom">
                      <Nav.Link
                        className="padding-zeroo"
                        href="/coordinatorhome/notifications"
                      >
                        <span className="icon">
                          <Icon style={{ fontSize: 30 }}>notifications </Icon>
                          {this.state.coordinatorNotificationCount > 0 && (
                            <Badge
                              style={{ verticalAlign: "top" }}
                              variant="danger"
                            >
                              {this.state.coordinatorNotificationCount}
                            </Badge>
                          )}
                        </span>
                      </Nav.Link>
                  ...
                  {this.state.panel === "supervisor" && (
                    <BootstrapTooltip1 title="Notifications" placement="bottom">
                      <Nav.Link
                        className="padding-zeroo"
                        href="/supervisorhome/notifications"
                      >
                        <span className="icon">
                          <Icon style={{ fontSize: 30 }}>notifications </Icon>
                          {this.state.supervisorNotificationCount > 0 && (
                            <Badge
                              style={{ verticalAlign: "top" }}
                              variant="danger"
                            >
                              {this.state.supervisorNotificationCount}
                            </Badge>
                          )}
                        </span>
                      </Nav.Link>
                ...
                <MDBNavItem>
                  {this.state.isCoordinator || this.state.isSupervisor ? (
                    ...
                    >
                      <MDBDropdownToggle nav>
                        <BootstrapTooltip1 title="Profile" placement="bottom">
                          <span className="icon">
                            <Icon style={{ fontSize: 30 }}>person</Icon>
                          </span>
                        </BootstrapTooltip1>
                      </MDBDropdownToggle>
                    ...
                    <BootstrapTooltip1 title="Profile" placement="bottom">
                      <Nav.Link className="padding-zero mr-3" href="/profile">
                        <span className="icon">
                          <Icon style={{ fontSize: 30 }}>person</Icon>
                        </span>
                      </Nav.Link>
                ...
                <MDBNavItem>
                  <BootstrapTooltip1 title="Logout" placement="bottom">
                    <Nav.Link className="padding-zeroo" onClick={this.logout}>
                      <span className="icon">
