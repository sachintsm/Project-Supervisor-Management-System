...
class CourseRegistration extends Component {
  ...
  componentDidMount() {
    axios.get(backendURI.url + "/courseTypes/get").then((res) => {
        ...
        buttons: [
          {
            ...
            onClick: () => {
              ...
              axios
                .post(backendURI.url + "/courseTypes/add", data, {
                  headers: headers,
                })
                .then((res) => {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            await axios
              .delete(backendURI.url + "/courseTypes/" + id, {
                headers: headers,
              })
              .then((res) => {
                if (res.data.state === true) {
        ...
        <div className="container-fluid ">
          ...
          <div className="container course-registration">
            ...
            <div className="card cr-card">
              <div
                className="container cr-content"
                style={{ marginTop: "20px", marginBottom: "10px" }}
              >
                <div className="container">
                  <label className="text-label-cr">
                    Course Name (i.e. : Computer Science)
                  </label>
                  <input
                  ...
                  <button
                    className="form-control btn btn-info my-4"
                    type="submit"
