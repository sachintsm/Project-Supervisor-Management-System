...
class CreateProject extends Component {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            if (
              this.state.selectedStaffList.length > 0 &&
              this.state.type !== ""
            ) {
              ...
              if (this.state.componentType === "add") {
                axios
                  .post(backendURI.url + "/projects", project, {
                    headers: headers,
                  })
                  .then((result) => {
                    if (result.data === "Exists") {
                      ...
                      if (
                        result.data.emptyStudents &&
                        result.data.emptyStudents.length > 0
                      ) {
                        ...
                        errorMsg =
                          errorMsg +
                          "students are not registered with the system";
                        this.setState(
                          {
              ...
              if (this.state.componentType === "edit") {
                axios
                  .patch(
                    backendURI.url + "/projects/" + this.state.id,
                    this.state,
                    { headers: headers }
                  )
                  .then((res) => {
                    if (res.data === "Exists") {
                      ...
                      // if students are not existing
                      if (
                        res.data.emptyStudents &&
                        res.data.emptyStudents.length > 0
                      ) {
  ...
  getCategoryList() {
    ...
    axios
      .get(backendURI.url + "/projects/projecttype", { headers: headers })
      .then((result) => {
        if (result.data.length > 0) {
          this.setState(
            {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            axios
              .patch(backendURI.url + "/projects/delete/" + id, {
                headers: headers,
              })
              .then((res) => {
                this.getProjectList();
  ...
  addIndex = () => {
    if (this.state.studentList.includes(this.state.newIndex)) {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            this.setState({
              studentList: this.state.studentList.filter((item) => {
                return item !== index;
              }),
            });
          },
                  ...
                  <div className="card card-1">
                    ...
                    <Row style={{ marginLeft: "0px", marginTop: "20px" }}>
                      <Col lg="4" md="4" sm="6" xs="6">
                        <Row>
                          <p className="cp-text">Course Year</p>
                        </Row>
                        <Row>
                          <DropdownButton
                            as={ButtonGroup}
                      ...
                      <Col lg="4" md="4" sm="6" xs="6">
                        <Row>
                          <p className="cp-text">Course Type</p>
                        </Row>
                      ...
                      {this.state.projectTypeList.length > 0 &&
                      this.state.projectTypeList[this.state.selectedTypeIndex]
                        .isAcademicYear ? (
                        <Col lg="4" md="4" sm="12" xs="12">
                          <Row>
                            <p className="cp-text cp-text">Academic Year</p>
                          </Row>
                          <Row>
                            <DropdownButton
                              as={ButtonGroup}
                    ...
                    <div style={{ marginTop: "20px", textAlign: "center" }}>
                      ...
                      {this.state.componentType === "add" && (
                        <div>
                          <Row style={{ paddingLeft: "15px" }}>
                            <p className="cp-text2">CSV File Format :</p>
                          </Row>
                          ...
                          <Row style={{ paddingLeft: "15px" }}>
                            <p className="cp-text2">Choose CSV File :</p>
                          </Row>
                                ...
                                >
                                  ...
                                  <Card className="index-card">
                                    <Card.Body className="index-card-body">
                                      {index}{" "}
                                      <span
                                        className="index-delete-icon"
                                        onClick={() => this.deleteIndex(index)}
                                      >
                                        <AiFillDelete />
                                      </span>
                                    </Card.Body>
                    ...
                    <Row style={{ marginTop: "40px", marginBottom: "30px" }}>
                      ...
                      <Col>
                        <Button
                          ...
                          style={{ width: "100%" }}
                        >
                          {this.state.componentType === "add" && "Create Now"}
                          {this.state.componentType === "edit" && "Save Now"}
                        </Button>
                      </Col>
                      <Col md={1}></Col>
                    </Row>
                              ...
                              {this.state.projects.map((project) => {
                                return (
                                  <tr key={project._id}>
                                    ...
                                    <td style={{ verticalAlign: "middle" }}>
                                      {project.projectType} {project.projectSu}
                                    </td>
                                    <td style={{ verticalAlign: "middle" }}>
                                    ...
                                    <td style={{ verticalAlign: "middle" }}>
                                      <CoordinatorList idList={project} />
                                    </td>
                                      ...
                                      <Row>
                                        ...
                                        <Col>
                                          <DeleteForeverIcon
                                            ...
                                            fontSize="large"
                                            onClick={() =>
                                              this.onDeleteHandler(project._id)
                                            }
                                          />
                                        </Col>
                                      </Row>
