    ...
    render() {
        return (
            ...
            <div >
                ...
                <div className="container  group-presentation " style={{ minHeight: "600px" }}>
                    ...
                    {this.state.Preliminary.length != 0 && (
                        ...
                        <Card className="submission-card">
                            <Card.Header className="gd-card-header">Preliminary Presentation Feedbacks</Card.Header>
                                    ...
                                    return (
                                        <div className="container">
                                            <Row className="prop-sub-row">
                                                <Col md="1" sm="3" xs="3">
                                                    <img className="mc-image" src={("http://localhost:4000/users/profileImage/" + item.image)} />
                                                </Col>
                                                <Col className="p-fb-tbl-row1" md="2" sm="9" xs="9">{item.supervisorName}</Col>
                                                <Col className="p-fb-tbl-row2" md="9" sm="12" xs="12">{item.feedback}</Col>
                                            </Row>
                                        </div>
                                    )
                                })}
                    ...
                    {this.state.Interim.length != 0 && (
                        ...
                        <Card className="submission-card">
                            <Card.Header className="gd-card-header">Interim Presentation Feedbacks</Card.Header>
                            <Card.Body className="gd-card-body">
                                {this.state.Interim.map(item => {
                                    return (
                                        <div className="container">
                                            <Row className="prop-sub-row">
                                                <Col md="1" sm="3" xs="3"><img className="mc-image" src={("http://localhost:4000/users/profileImage/" + item.image)} /></Col>
                                                <Col className="p-fb-tbl-row1" md="2" sm="9" xs="9">{item.supervisorName}</Col>
                                                <Col className="p-fb-tbl-row2" md="9" sm="12" xs="12">{item.feedback}</Col>
                                            </Row>
                                        </div>
                    ...
                    {this.state.Finals.length != 0 && (
                        ...
                        <Card className="submission-card">
                            <Card.Header className="gd-card-header">Final Presentation Feedbacks</Card.Header>
                            <Card.Body className="gd-card-body">
                                {this.state.Finals.map(item => {
                                    return (
                                        <div className="container">
                                            <Row className="prop-sub-row">
                                                <Col md="1" sm="3" sm="3" xs="3"><img className="mc-image" src={("http://localhost:4000/users/profileImage/" + item.image)} /></Col>
                                                <Col className="p-fb-tbl-row1" md="2" sm="9" xs="9">{item.supervisorName}</Col>
                                                <Col className="p-fb-tbl-row2" md="9" sm="12" xs="12">{item.feedback}</Col>
                                            </Row>
                                        </div>
