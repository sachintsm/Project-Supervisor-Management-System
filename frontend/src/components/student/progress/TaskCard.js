                                ...
                                <Card.Header className="card-header">{this.state.task.taskTitle} ({this.state.task.totalProgress}%)
                                    {this.state.userLevel === "student" && (
                                        <BootstrapTooltip1 title={this.state.deleteTitle} placement="bottom">
                                            <span className="delete-span" onMouseEnter={() => { this.setState({ viewTitle: "", }) }} onMouseLeave={() => this.setState({ viewTitle: "View " + this.state.task.taskTitle, })} onClick={this.deleteTask}>
                                                <AiFillDelete />
                                            </span>
                                        </BootstrapTooltip1>
                                    )}
