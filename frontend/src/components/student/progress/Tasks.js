        ...
        <div className="container-fluid tasks tasks-background-color">
          <div className="main-card">
            <div className="title-div">
              {this.state.groupDetails.groupName && (
                <h2 className="project-task-title">
                  Progress ( {this.state.groupDetails.groupName} - Group{" "}
                  {this.state.groupDetails.groupId} )
                </h2>
              )}
              {!this.state.groupDetails.groupName && (
                <h2 className="project-task-title">
                  Progress ( Group {this.state.groupDetails.groupId} )
                </h2>
              )}
            </div>
            ...
            <Row>
              ...
              {!this.state.loading &&
                this.state.project.projectState &&
                  ...
                  <Col lg={3} md={3} xs={12} sm={12}>
                    <BootstrapTooltip title="Add New Task" placement="bottom">
                      ...
                      >
                        ...
                        <span className="btn-title">Add New Task</span>
                      </Card>
                    </BootstrapTooltip>
                  </Col>
                )}
                ...
                <form onSubmit={this.onSubmit}>
                  <div className="form-group title-form-group">
                    ...
                    <Input
                      ...
                      placeholder="Eg :- Login Page / User Registrations"
                    />
                    {this.state.taskTitleError && !this.state.taskTitle ? (
                  ...
                  <div className="form-group">
                    <Label for="avatar">
                      Task Weight ( 1-10 )
                      <BootstrapTooltip
                        title="Define an approximate weight for the Task. Give higher weight for complex tasks and lower weight for simple tasks. Total Progress will be calculated according to the Task Weights"
                        placement="right"
                      >
