...
class ViewTask extends Component {
  ...
  getProgressUpdates = () => {
    ...
    axios
      .get(backendURI.url + "/progress/gettaskprogressupdates/" + taskId, {
        headers: headers,
      })
      .then((res) => {
  ...
  getTaskDetails = () => {
    ...
    axios
      .get(backendURI.url + "/progress/gettaskdetails/" + this.state.taskId, {
        headers: headers,
      })
      .then((res) => {
        this.setState({
          ...
          loading: false,
          progressHint:
            "Increase or Decrease the progress of " + res.data.taskTitle,
        });
      });
  };
        ...
        buttons: [
          {
            ...
            onClick: async () => {
              ...
              axios
                .patch(
                  backendURI.url + "/progress/edittask/" + this.state.task._id,
                  object,
                  { headers: headers }
                )
                .then((res) => {
        ...
        buttons: [
          {
            ...
            onClick: async () => {
              ...
              axios
                .post(backendURI.url + "/progress/addprogressupdate/", object, {
                  headers: headers,
                })
                .then((res) => {
                  // console.log(res)
                  ...
                  <Row className="task-options">
                          ...
                          <form onSubmit={this.onSubmit}>
                            <div className="form-group">
                              <Label for="avatar">
                                ...
                                {this.state.task.taskTitle === "" && (
                                  <span className="title-error">*Required</span>
                                )}
                              </Label>
                              <Input
                                type="text"
                            ...
                            <div className="form-group">
                              <Label for="avatar">
                                Task Weight ( 1-10 )
                                <BootstrapTooltip
                                  title="Change your approximate Task Weight. Give higher weight for complex tasks and lower weight for simple tasks. Total Progress will be calculated according to the Task Weights"
                                  placement="right"
                                >
                              ...
                              <div className="slider-div">
                                <ThemeProvider theme={muiTheme}>
                                  <Slider
                                    defaultValue={this.state.defaultTaskWeight}
                                    onChange={this.taskWeightHandler}
                            ...
                            <div className="form-group">
                              <Row className="btn-row">
                                <Col
                                  ...
                                  sm={6}
                                  xs={6}
                                  className="my-btn1-div"
                                >
                                  <Button
                                    className="btn btn-danger my-4 my-btn1"
                                ...
                                <Col
                                  ...
                                  sm={6}
                                  xs={6}
                                  className="my-btn2-div"
                                >
                                  <Button
                                    className="btn btn-info my-4 my-btn2"
                    ...
                    <Col lg={6} md={6} className="update-card-div">
                      <Card className="update-card">
                        ...
                        {this.state.task.totalProgress <
                          this.state.defaultProgress && (
                          <div>
                            <label>New Task Progress </label>
                            <label
                        ...
                        {this.state.task.totalProgress >
                          ...
                          <div>
                            ...
                            <label
                              style={{ fontWeight: "bold", color: "#27d600" }}
                            >
                              {" "}
                              (+
                              {this.state.task.totalProgress -
                        ...
                        <ThemeProvider theme={muiTheme}>
                          <Slider
                            defaultValue={this.state.defaultProgress}
                            onChange={this.progressHandler}
                        ...
                        <form>
                          <label className="label-description">
                            Description
                            <BootstrapTooltip
                              title="Briefly explain changes in the update"
                              placement="right"
                            >
                              <span className="question-span">&#9432;</span>
                            </BootstrapTooltip>
