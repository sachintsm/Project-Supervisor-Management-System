...
class BiweeklyView extends Component {
  ...
  biweeklyView = (data) => {
    this.props.history.push(
      "/studenthome/biweeklysubmissionpanel/" + data._id,
      {
                    ...
                    return (
                      ...
                      >
                        <div className="row">
                          <div
                            className="col-xm-1"
                            style={{ backgroundColor: "#263238", width: 35 }}
                          ></div>
                          <div className="col-sm-11">
                            <h2 className="sup-tittle">
                              ...
                              <Col md={10} xs={10}>
                                <a href="#0">
                                  ...
                                  <span className="sub-content">
                                    {type.proposelTittle} Biweekly Submite
                                    (Deadline - {type.deadDate}: {type.deadTime}
                                    )
                                  </span>
                                </a>
                              </Col>
