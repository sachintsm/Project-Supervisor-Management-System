                            ...
                            <Row>
                                ...
                                <Col md={9} lg={9} xs={12} sm={12} className="details-col">
                                    <Row className="details-row">
                                        <Col lg={3} md={4} sm={6} xs={6} className="zero-padding"><span className="bold-text">Project Year </span></Col>
                                        <Col lg={9} md={8} sm={6} xs={6} className="zero-padding"><span className="normal-text">{this.state.item.projectYear}</span></Col>
                                    </Row>
                                    <Row  className="details-row">
                                        <Col lg={3} md={4} sm={6} xs={6} className="zero-padding"><span className="bold-text">Project Type</span></Col>
                                        <Col lg={9} md={8} sm={6} xs={6} className="zero-padding"><span className="normal-text">{this.state.item.projectType}</span></Col>
                                    </Row>
                                    <Row  className="details-row">
                                        <Col lg={3} md={4} sm={6} xs={6} className="zero-padding"><span className="bold-text">Academic Year</span></Col>
                                        <Col lg={9} md={8} sm={6} xs={6} className="zero-padding"><span className="normal-text">{this.state.item.academicYear}</span></Col>
                                    </Row>
                                    <Row  className="details-row">
                                        <Col lg={3} md={4} sm={6} xs={6} className="zero-padding"><span className="bold-text">Coordinators</span></Col>
                                        <Col lg={9} md={8} sm={6} xs={6}><Row className="normal-text"><CoordinatorList idList={this.state.item}/></Row></Col>
                                    </Row>
                                    <Row  className="details-row">
                                        <Col lg={3} md={4} sm={6} xs={6} className="zero-padding"><span className="bold-text">Supervisors</span></Col>
                                        <Col lg={9} md={8} sm={6} xs={6}><Row className="normal-text"><SupervisorList idList={this.state.groupDetails.supervisors}/></Row></Col>
                                    </Row>
                                </Col>
                            </Row>
                        </Card.Body>
