                ...
                buttons: [
                    {
                        ...
                        onClick: async () => {
                            ...
                            axios.patch(backendURI.url+'/createGroups/groupDetails/'+this.state.groupDetails._id, data,{headers:headers}).then(res=>{
                                this.getGroup()
                                this.setState({
                                    successAlert: true
                                })
                ...
                <div className="project-details-card-div2">
                    ...
                    <div>
                        <Card className="project-details-card"   onClick={()=>this.openProject(this.state.item)}>
                            ...
                            <Card.Header className="card-header">{this.state.groupDetails.groupName} ( Group {this.state.groupDetails.groupId} )
                                <BootstrapTooltip1 title="Edit Details" placement="bottom">
                                            <span className="edit-span"  onClick={()=>{this.openModal()}}>
                                                <FiEdit />
                                            </span>
                                </BootstrapTooltip1>
                            </Card.Header>
                            ...
                            <Card.Body className="card-body">
                                <Row>
                                    ...
                                    <Col md={9} lg={9} xs={12} sm={12} className="details-col">
                                        ...
                                        <Row  className="details-row">
                                            <Col lg={3} md={4} sm={6} xs={6} className=""><span className="bold-text">Group Email</span></Col>
                                            {this.state.groupDetails.groupEmail && <Col lg={9} md={8} sm={6} xs={6} className="zero-padding"><span className="normal-text">{this.state.groupDetails.groupEmail}</span></Col>}
                                            {!this.state.groupDetails.groupEmail && <Col lg={9} md={8} sm={6} xs={6} className="zero-padding"><span className="error-text">Please add your group Email</span></Col>}
                                ...
                                <div style={{ width: "100%", margin: "auto", marginTop: "10px" }}>
                                    <form onSubmit={this.onSubmit}>
                                        ...
                                        <div className="form-group title-form-group">
                                            ...
                                            <Input type="text" className="form-control" name="project-title" onChange={this.onChangeProjectTitle} placeholder="Insert your Project Title" value={this.state.groupName}/>
                                        </div>
                                        ...
                                        <div className="form-group title-form-group">
                                            ...
                                            <Input type="text" className="form-control" name="group-email" onChange={this.onChangeGroupEmail} placeholder="Insert your Group Email" value={this.state.groupEmail}/>
                                        </div>

                                        <div className="form-group">
                                            <Button className="btn btn-info my-4" type="submit" block>Edit Now</Button>
                                        </div>
                                    </form>
                                </div>
                            </div>
