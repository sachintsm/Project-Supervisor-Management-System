...
class ViewProjects extends Component {
  ...
  getProjectList() {
    ...
    axios
      .get(backendURI.url + "/projects/studentprojects/" + studentId.id, {
        headers: headers,
      })
      .then((result) => {
        ...
        <div className="container-fluid view-projects view-project-background-color">
          <Container>
            <div className="card card-div current-card add-card">
              <h3 className="title">
                Ongoing Projects <span className="dot"></span>
              </h3>
              <div className="project-list-div">
                ...
                {this.state.activeList.length === 0 && !this.state.loading && (
                  <p className="no-project">No Projects</p>
                )}
            ...
            <div className="card card-div ended-card">
              ...
              <div className="project-list-div">
                ...
                {this.state.endedList.length === 0 && !this.state.loading && (
                  <p className="no-project">No Projects</p>
                )}
                <Row className="project-row">
