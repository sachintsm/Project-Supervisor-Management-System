...
class SubmitPanal extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      proposelTittle: this.props.location.state.submissionDetails
        .proposelTittle,
      ...
      proposelDiscription: this.props.location.state.submissionDetails
        .proposelDiscription,
  ...
  componentDidMount() {
    ...
    axios
      .post(backendURI.url + "/submission/get", dt)
      .then((res) => {
        this.setState({
  ...
  async handleSave(files) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      await axios
        .post(backendURI.url + "/submission/add", formData)
        .then((res) => {});
    }
  }
    ...
    return (
      <React.Fragment>
        ...
        <div className="sub_style">
          ...
          >
            <div className="container">
              <p className="sub_tittle">
                {this.state.proposelTittle} Submission{" "}
                <small>
                  {" "}
          ...
          <div
            className="container-fluid sub_backgrounds"
            style={{ backgroundColor: "#f5f5f5" }}
          >
            <div className="container">
              <div>
